...
518 million years ago, with (b) its inferred position shown on the vertebrate phylogeny.  From <a rel="nofollow" class="external free" href="https://doi.org/10.1098/rsos.240350">a paper by Rudy Lerosey-Aubril &amp; Javier Ortega-Hernández</a>, <a href="https://creativecommons.org/licenses/by/4.0" title="Creative Commons Attribution 4.0">CC BY 4.0</a> From Wikimedia.</div></figcaption></figure>
</div>
...
Granville Sewell is a mathematician, who is Professor Emeritus in the Departrment of Mathematical Sciences at the University of Texas at El Paso.  He is a specialist in numerical solution of differential equations. Here is how he invokes physics to solve this problem:
...
to the left of the bush, over the log, and to the right of the tree, and there will be the burrow."  The mouse is making a representation of its environment which includes a representation of itself, viewed from outside.  From there, more elaborate forms of consciousness could, I think, evolve.
