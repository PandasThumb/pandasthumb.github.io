  ...
  module Importers
    class MT < Importer
      ...
      def self.process(options)
        ...
        authors = db[:mt_author].to_hash(:author_id,:author_nickname)
        ...
        posts.each do |post|
          ...
          data = post_metadata(post, authors, options)
      ...
      def self.post_metadata(post, authors, options = default_options)
        metadata = {
          'layout' => 'article',
          ...
          'author' => authors[post[:entry_author_id]],
          'mt_id' => post[:entry_id],
